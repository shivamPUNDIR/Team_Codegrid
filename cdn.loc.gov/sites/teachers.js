    ...
    share: function($){ 
        $.env({
            defaults:{ locshare:{
                root:'/share/',
                app_id:'cED6uju6',
                site_name: 'the Library of Congress for teachers',
                subscribe_url: '/share/sites/teachers/subscribe.php',
                survey_url: '/share/survey.php?survey_link=https://www.research.net/r/libraryofcongress?site=Teachers'
            }}
        });
    }
